...
WebUI.callTestCase(findTestCase('03 - Websites Modules/Page - Checkout Shipping Address/Input Valid Shipping Address'),['first_name':first_name,'last_name':last_name,'address1':address1,'address2':address2,'city':city,'zip_postal':zip_postal,'phone':phone])
...
WebUI.callTestCase(findTestCase('03 - Websites Modules/Page - Checkout Payment/Update Guest Checkout Paypal Billing Address'),['first_name':first_name,'last_name':last_name,'address1':address1,'address2':address2,'city':city,'country_diminutive':country_diminutive,'zip_postal':zip_postal,'phone':phone])
WebUI.callTestCase(findTestCase('03 - Websites Modules/Page - Checkout Payment/Input New Credit Card'),['card_number':card_number,'cardholder_name':cardholder_name,'expdate_month':expdate_month,'expdate_year':expdate_year,'security_code':security_code])
...
WebUI.callTestCase(findTestCase('03 - Websites Modules/Page - Checkout Order Confirmation/Get Order Details'),['test_case':test_case])

//Saving output data and closing browser
WebUI.callTestCase(findTestCase('02 - Katalon Modules/Scenario Post Script for Checkout'),['order_uuid':order_uuid,'test_case':test_case])
